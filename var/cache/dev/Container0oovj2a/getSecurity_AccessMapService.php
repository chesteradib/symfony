...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/m/login$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/login/login$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
