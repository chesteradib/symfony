...
$instance->addLoader('resample', ${($_ = isset($this->services['liip_imagine.filter.loader.resample']) ? $this->services['liip_imagine.filter.loader.resample'] : $this->load('getLiipImagine_Filter_Loader_ResampleService.php')) && false ?: '_'});
...
$instance->addPostProcessor('optipng', ${($_ = isset($this->services['liip_imagine.filter.post_processor.optipng']) ? $this->services['liip_imagine.filter.post_processor.optipng'] : $this->load('getLiipImagine_Filter_PostProcessor_OptipngService.php')) && false ?: '_'});
