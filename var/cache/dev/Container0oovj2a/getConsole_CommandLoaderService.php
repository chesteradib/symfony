...
}, 'fos_elastica.command.create' => function () {
    $f = function (\FOS\ElasticaBundle\Command\CreateCommand $v) { return $v; }; return $f(${($_ = isset($this->services['fos_elastica.command.create']) ? $this->services['fos_elastica.command.create'] : $this->load('getFosElastica_Command_CreateService.php')) && false ?: '_'});
}, 'fos_elastica.command.populate' => function () {
    $f = function (\FOS\ElasticaBundle\Command\PopulateCommand $v) { return $v; }; return $f(${($_ = isset($this->services['fos_elastica.command.populate']) ? $this->services['fos_elastica.command.populate'] : $this->load('getFosElastica_Command_PopulateService.php')) && false ?: '_'});
}, 'fos_elastica.command.reset' => function () {
    $f = function (\FOS\ElasticaBundle\Command\ResetCommand $v) { return $v; }; return $f(${($_ = isset($this->services['fos_elastica.command.reset']) ? $this->services['fos_elastica.command.reset'] : $this->load('getFosElastica_Command_ResetService.php')) && false ?: '_'});
}, 'fos_elastica.command.search' => function () {
    $f = function (\FOS\ElasticaBundle\Command\SearchCommand $v) { return $v; }; return $f(${($_ = isset($this->services['fos_elastica.command.search']) ? $this->services['fos_elastica.command.search'] : $this->load('getFosElastica_Command_SearchService.php')) && false ?: '_'});
