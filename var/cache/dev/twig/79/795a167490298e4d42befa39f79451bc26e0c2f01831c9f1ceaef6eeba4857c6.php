...
class __TwigTemplate_541ece0d66ce374ab112b4b1c92a1bad56f30ae5c8c16a9e1137135176c1e11c extends Twig_Template
{
    ...
    ";
        ...
        <div class=\"sf-toolbar-info-piece\">
            ...
            <span>";
        // line 36
        echo twig_escape_filter($this->env, sprintf("%0.2f", $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "executionTime", array())), "html", null, true);
        echo " ms</span>
        </div>
    ";
        ...
        // line 39
        echo "    ";
        $this->loadTemplate("@WebProfiler/Profiler/toolbar_item.html.twig", "FOSElasticaBundle:Collector:elastica.html.twig", 39)->display(array_merge($context, array("link" => ($context["profiler_url"] ?? $this->getContext($context, "profiler_url")))));
    ...
    <span class=\"label ";
        // line 45
        echo (($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "querycount", array())) ? ("") : ("disabled"));
        echo "\">
        ";
        // line 46
        if ((($context["profiler_markup_version"] ?? $this->getContext($context, "profiler_markup_version")) == 1)) {
...
";
    ...
    ";
        // line 58
        if ( !$this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "querycount", array())) {
            // line 59
    ...
    {
        return array (  353 => 98,  338 => 96,  332 => 93,  327 => 92,  324 => 91,  304 => 88,  299 => 87,  297 => 86,  294 => 85,  289 => 83,  286 => 82,  283 => 81,  278 => 79,  275 => 78,  273 => 77,  268 => 75,  263 => 73,  259 => 72,  254 => 70,  243 => 68,  239 => 67,  235 => 66,  230 => 65,  213 => 64,  210 => 63,  204 => 59,  202 => 58,  198 => 56,  189 => 55,  177 => 51,  171 => 49,  167 => 47,  165 => 46,  161 => 45,  158 => 44,  155 => 43,  146 => 42,  135 => 39,  129 => 36,  122 => 32,  115 => 28,  111 => 26,  108 => 25,  105 => 24,  102 => 23,  95 => 19,  91 => 17,  89 => 16,  85 => 15,  80 => 14,  77 => 13,  71 => 11,  69 => 10,  65 => 9,  62 => 8,  59 => 7,  57 => 6,  54 => 5,  51 => 4,  42 => 3,  11 => 1,);
    }
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "FOSElasticaBundle:Collector:elastica.html.twig", "/vagrant/vendor/friendsofsymfony/elastica-bundle/src/Resources/views/Collector/elastica.html.twig");
    }
}
