...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "WebProfilerBundle:Collector:cache.html.twig", "/vagrant/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/cache.html.twig");
    }
}
