...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "WebProfilerBundle:Collector:validator.html.twig", "/vagrant/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/validator.html.twig");
    }
}
